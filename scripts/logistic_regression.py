...
f = open('logistic_regression_report.txt', 'w')
...
model_perf = model_perf.append({'ngram':'uni',
                                'model': 'logistic_regression', 
                                'parameters': {'multi_class':'ovr', 'class_weight':'balanced', 'penalty':'l1'}, 
                                'accuracy': accuracy_score(y_test, y_pred), 
                                'precision': precision_score(y_test, y_pred, average='macro'), 
                                'recall': recall_score(y_test, y_pred, average='macro'), 
                                'F1': f1_score(y_test, y_pred, average="macro")}, ignore_index=True)
...
model_perf = model_perf.append({'ngram':'uni',
                                'model': 'logistic_regression', 
                                'parameters': {'multi_class':'multinomial', 'class_weight':'balanced', 'solver':'lbfgs', 'penalty':'l2', 'max_iter':200}, 
                                'accuracy': accuracy_score(y_test, y_pred), 
                                'precision': precision_score(y_test, y_pred, average='macro'), 
                                'recall': recall_score(y_test, y_pred, average='macro'), 
                                'F1': f1_score(y_test, y_pred, average="macro")}, ignore_index=True)
...
model_perf = model_perf.append({'ngram':'uni + bi',
                                'model': 'logistic_regression', 
                                'parameters': {'multi_class':'ovr', 'class_weight':'balanced', 'solver':'liblinear', 
