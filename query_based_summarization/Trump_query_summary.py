...
if __name__ == "__main__":
    ...
    # Splitting into paragraphs - 10 sentences
    ...
    while(i < len(sentences)):
        paragraph = ' '.join(sentences[i:i+10])
    ...
    with open('./artifacts/trump_corpus.pkl', 'wb') as f:
    ...
    with open('./artifacts/trump_lemmatized.pkl', 'wb') as f:
    ...
    model.save("./artifacts/trump_d2v.model") # saving model for future use
